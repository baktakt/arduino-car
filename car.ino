...
if(Fspeedd < 15) // if distance less then 10
{
Serial.print("Distance < 20. Stopping and reversing.");
stopp(1);
back(2);
}
if(Fspeedd < 30) // if distance less then 10
{
Serial.print("Distance < 35. Stopping and looking around.");
stopp(1);
ask_pin_L();
delay(delay_time);
ask_pin_R();
